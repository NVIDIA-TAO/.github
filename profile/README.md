...
<p align="center">
  <img src="https://raw.githubusercontent.com/NVIDIA-TAO/.github/main/profile/NVIDIA-TAO-repo-map.png" alt="NVIDIA TAO repository map: the skill bank interface, an optional tao-sdks execution layer, a data → train & tune → deploy workflow, on top of tao-core shared infrastructure." width="78%" />
</p>
